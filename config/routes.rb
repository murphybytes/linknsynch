Linknsynch::Application.routes.draw do
  devise_for :users
  ...
  match 'graphs/heatingsummary' => 'graphs#heatingsummary', :as => :heating_summary_graph
  match 'graphs/unservedsummary' => 'graphs#unservedsummary', :as => :unserved_summary_graph
